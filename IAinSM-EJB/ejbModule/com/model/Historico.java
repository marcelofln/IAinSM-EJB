...
@NamedQuery(name="Historico.findAllPapelHist", query="select u from Historico u where u.cod_negociacao = :cod_negociacao")
@Entity
@Table(name="BASE_HISTORICA")
public class Historico {

	public static final String FIND_BY_PAPEL_HIST = "Historico.findAllPapelHist";
	...
	private String nome_user_Historico;
	...
	public String getNome_user_Historico() {
		return nome_user_Historico;
	}
	public void setNome_user_Historico(String nome_user_Historico) {
		this.nome_user_Historico = nome_user_Historico;
	}
	@Override
	public int hashCode() {
	    return getId();
